...
%  \begin{small}
%  \begin{itemize}[leftmargin=*]
%  \item \textbf{Built a web-app} to convert meeting audio into summary text in a private and interpretable fashion
%  \item Integrated the Sphinx \textbf{audio recognition} software to convert sound files into sentences
%  \item Designed text summarization pipeline using \textbf{natural language processing tools} including gensim and spacy
%  \end{itemize}
%  \end{small}
%  \end{flushleft}
 %%%%%%%%%%%%
